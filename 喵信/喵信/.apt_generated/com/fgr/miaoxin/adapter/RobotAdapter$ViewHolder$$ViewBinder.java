...
public class RobotAdapter$ViewHolder$$ViewBinder<T extends com.fgr.miaoxin.adapter.RobotAdapter.ViewHolder> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131165278, "field 'tvContent'");
    target.tvContent = finder.castView(view, 2131165278, "field 'tvContent'");
    view = finder.findRequiredView(source, 2131165276, "field 'tvTime'");
    target.tvTime = finder.castView(view, 2131165276, "field 'tvTime'");
